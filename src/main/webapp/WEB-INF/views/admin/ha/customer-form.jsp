...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/customers/customer-form.css">
</head>
<body>
    ...
    <main class="main-content">
        ...
        <header class="navbar">
            <div class="breadcrumb">
                <span>FamiCoats</span> / <a href="<%= contextPath %>/admin/customers" style="color: #64748b; text-decoration: none;">Quản lý khách hàng</a> / <span class="active-crumb"><%= isEdit ? "Chỉnh sửa hồ sơ" : "Thêm mới" %></span>
            </div>
...
<script src="${pageContext.request.contextPath}/assets/js/customers/customer-form.js"></script>
</body>
</html>
