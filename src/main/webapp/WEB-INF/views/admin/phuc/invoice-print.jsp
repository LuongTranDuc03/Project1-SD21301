                    ...
                    <%@ page import="java.time.format.DateTimeFormatter" %>
                        ...
                        <head>
                            ...
                            <link
                                ...
                                rel="stylesheet">
                            <link rel="stylesheet"
                                href="${pageContext.request.contextPath}/assets/css/invoices/invoice-print.css?v=<%= System.currentTimeMillis() %>">
                        </head>
                                                        ...
                                                        <div class="invoice-doc">
                                                            ...
                                                            <div class="doc-fin">
                                                                ...
                                                                <div class="doc-fin-row">
                                                                    ...
                                                                    <span class="val">
                                                                        ...
                                                                        <div class="doc-fin-sub">Thanh toán qua:
                                                                            <strong>
                                                                                <%= payMethod %>
                                                                            </strong></div>
                                                            </div>
                                                            ...
                                                            <div class="doc-note">
                                                                ...
                                                                <div class="doc-note-text">
                                                                    <%= (inv.getNote() !=null &&
                                                                        !inv.getNote().isEmpty()) ? inv.getNote()
