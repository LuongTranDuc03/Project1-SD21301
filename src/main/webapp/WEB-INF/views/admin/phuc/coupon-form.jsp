                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/coupons/save" id="couponForm" novalidate>
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                        ...
                        <div class="cf-grid" style="gap: 20px 24px; align-items: start;">
                            ...
                            <div class="cf-group">
                                <label class="cf-label" for="usagePerCustomer">Hạn mức / 1 KH <span class="req">*</span></label>
                                <input type="number" id="usagePerCustomer" name="usagePerCustomer" class="cf-input" value="<%= usagePerCustomer %>" min="1" step="1" required>
                            </div>
                            <% if (isEdit) { %>
                            <div class="cf-group">
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px;">
                        ...
                        <div class="cf-grid" style="gap: 20px 24px; align-items: start;">
                            <div class="cf-group">
                                ...
                                <input type="datetime-local" id="startDate" name="startDate" class="cf-input" value="<%= startDate %>" required>
                            </div>
                            <div class="cf-group">
                                <label class="cf-label" for="endDate">Thời gian kết thúc <span class="req">*</span></label>
                                <input type="datetime-local" id="endDate" name="endDate" class="cf-input" value="<%= endDate %>" required>
                            </div>
