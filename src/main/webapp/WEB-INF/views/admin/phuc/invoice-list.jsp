                                                        ...
                                                        <div class="page-header"
                                                            ...
                                                            <div class="cl-actions">
                                                                <% StringBuilder exportUrl=new
                                                                    ...
                                                                    + "/admin/invoices/export-excel?_=1" ); if
                                                                ...
                                                                <table class="il-table admin-table"
                                                                    ...
                                                                    <tbody>
                                                                        <% if (invoices !=null && !invoices.isEmpty()) {
                                                                            int stt=1; for (Invoice inv : invoices) {
                                                                            int s=inv.getOrderStatus(); String
                                                                            bCls=badgeClass.apply(s); String
                                                                            ...
                                                                            inv.getCustomerName() : "" ; String
                                                                            custPhone=inv.getCustomerPhone() !=null ?
                                                                            inv.getCustomerPhone() : "" ; String
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align:center;">
                                                                                    <div
                                                                                        ...
                                                                                        <a href="${pageContext.request.contextPath}/admin/invoices/print?id=<%= inv.getId() %>" target="_blank"
                                                                                            class="action-icon-btn"
                                                                                            title="In hoá đơn"
                                                                                            style="text-decoration: none; display: inline-flex; align-items: center; justify-content: center; color: #10B981;">
                                                                                            <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" stroke-width="2.2" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>
                                                                                        </a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                ...
                                                                <div class="il-pagination">
                                                                    ...
                                                                    <div class="paging-btns">
                                                                        <a href="<%= baseUrl %>page=<%= pageNo - 1 %>"
                                                                            ...
                                                                            : "" %>">‹</a>
                                                                        <% int startPage=Math.max(0, pageNo - 2); int
                                                                                ...
                                                                                <% } %>
                                                                                    <% } for (int i=startPage; i
                                                                                        ...
                                                                                        <a href="<%= baseUrl %>page=<%= i %>"
                                                                                            class="pg-btn <%= i == pageNo ? "active" : "" %>"><%= i + 1 %></a>
