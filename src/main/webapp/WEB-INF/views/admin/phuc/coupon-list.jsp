        ...
        <% } %>
            ...
            <div class="custom-card">
                ...
                <div class="card-body-content" id="filterCardBody">
                    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/coupons/coupon-list.css">
...
<script src="${pageContext.request.contextPath}/assets/js/coupons/coupon-list.js"></script>
