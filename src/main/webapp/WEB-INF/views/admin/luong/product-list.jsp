...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/products/product-list.css">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/assets/js/products/product-list.js"></script>
</html>
