    ...
    <%@ page import="project.duan1_sd21301.model.luong.ProductDetail" %>
        <%@ page import="java.util.List" %>
            <%@ page import="project.duan1_sd21301.model.huy.Employee" %>
                <% Employee loggedInUser=(Employee) session.getAttribute("loggedInUser"); boolean
                    isManager=(loggedInUser !=null && loggedInUser.getRoleId()==1); %>
                    <!DOCTYPE html>
                    <html lang="vi">
                    ...
                    <head>
                        ...
                        <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/products/variant-list.css">
                    </head>
                    ...
                    <body>
                        <div class="app-container">
                            ...
                            <main class="main-content">
                                ...
                                <header class="navbar">
                                    <div class="breadcrumb">
                                        <span>FamiCoats</span> / <a
                                            ...
                                            style="color: inherit; text-decoration: none;">Quản lý sản phẩm</a> / <span
                                            class="active-crumb">Danh sách biến thể</span>
                                    </div>
                                    <div class="navbar-right">
                                        ...
                                        <div class="profile-pill">
                                            <span>${sessionScope.currentUserRole != null ? sessionScope.currentUserRole
                                                : 'Hệ thống'}</span>
                                        </div>
                                    </div>
                                </header>
                                ...
                                <div class="content-wrapper">
                                    <% List<ProductDetail> variants = (List<ProductDetail>)
                                            ...
                                            java.util.Set<String> sizes = new java.util.TreeSet<>();
                                                    ...
                                                    if (v.getPrice() < globalMinPrice) globalMinPrice=v.getPrice(); if
                                                        (v.getPrice()> globalMaxPrice) globalMaxPrice = v.getPrice();
                                                        }
                                                        }
                                                        if (globalMinPrice == Double.MAX_VALUE) globalMinPrice = 0.0;
                                                        if (globalMaxPrice < globalMinPrice)
                                                            globalMaxPrice=globalMinPrice; long sliderMin=(long)
                                                            Math.floor(globalMinPrice); long sliderMax=(long)
                                                            Math.ceil(globalMaxPrice); if (sliderMax <=sliderMin)
                                                                    ...
                                                                    <div class="subtitle">
                                                                        Tổng <%= totalVariants %> biến thể
                                                                            <%= (filterProductId !=null &&
                                                                                !filterProductId.trim().isEmpty())
                                                                                ? " của sản phẩm <strong>" +
                                                                                filterProductId + "</strong>"
                                                                                : " trên toàn hệ thống" %>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="filter-grid-single-line"
                                                                        ...
                                                                        <div class="filter-field"
                                                                            ...
                                                                            <label for="sizeFilter"
                                                                                style="font-size: 12px; font-weight: 600; color: #475569; margin-bottom: 6px; display: block;">Kích
                                                                                cỡ</label>
                                                                            <select id="sizeFilter"
                                                                                class="filter-control"
                                                                                onchange="applyFilters()"
                                                                                style="height: 38px; box-sizing: border-box;">
                                                                                <option value="">-- Tất cả kích cỡ --
                                                                                </option>
                                                                                <% for (String s : sizes) { %>
                                                                                    <option value="<%= s %>">
                                                                                        <%= s %>
                                                                        ...
                                                                        <div class="filter-field"
                                                                            ...
                                                                            <label
                                                                                style="font-size: 12px; font-weight: 600; color: #475569; margin-bottom: 6px; display: block;">Trạng
                                                                                thái</label>
                                                                            <input type="hidden" id="statusFilter"
                                                                                value="">
                                                                            <div
                                                                                style="display: flex; gap: 12px; align-items: center; height: 38px; padding: 0 6px;">
                                                                                <label
                                                                                    style="display: flex; align-items: center; gap: 4px; font-size: 13px; cursor: pointer; color: #1e293b; margin: 0;">
                                                                                    <input type="radio"
                                                                                        name="statusRadio" value=""
                                                                                        onchange="document.getElementById('statusFilter').value=this.value; applyFilters()"
                                                                                        checked> Tất cả
                                                                                </label>
                                                                                <label
                                                                                    style="display: flex; align-items: center; gap: 4px; font-size: 13px; cursor: pointer; color: #1e293b; margin: 0;">
                                                                        ...
                                                                        <div class="filter-field"
                                                                            style="flex: 1.5; min-width: 170px;">
                                                                            <label id="priceLabel"
                                                                                style="display: flex; justify-content: space-between; align-items: center; width: 100%; font-size: 12px; font-weight: 600; color: #475569; margin-bottom: 6px;">
                                                                                <span>Khoảng giá</span>
                                                                                <span id="priceRangeText"
                                                                                    style="font-weight: 700; color: #10b981; font-size: 11px;"></span>
                                                                            </label>
                                                                            <div class="price-slider-container"
                                                                                style="height: 38px; display: flex; align-items: center; position: relative; width: 100%; margin: 0;">
                                                                                <div class="slider-track"></div>
                                                                                <input type="range" id="minPriceInput"
                                                                                    min="<%= sliderMin %>"
                                                                                    max="<%= sliderMax %>" step="1000"
                                                                                    value="<%= sliderMin %>"
                                                                                    oninput="updateSlider()">
                                                                                <input type="range" id="maxPriceInput"
                                                                                    min="<%= sliderMin %>"
                                                                                    max="<%= sliderMax %>" step="1000"
                                                                                    value="<%= sliderMax %>"
                                                                                    oninput="updateSlider()">
                                                                        ...
                                                                        <div class="filter-field"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                onclick="resetFilters()" id="resetBtn"
                                                                                style="visibility: hidden; display: flex; align-items: center; gap: 6px; padding: 0 16px; font-weight: 600; border-radius: 6px; border: 1px solid #cbd5e1; background: #ffffff; color: #475569; cursor: pointer; transition: all 0.2s; font-size: 13px; white-space: nowrap; box-sizing: border-box; height: 38px;">
                                                            ...
                                                            <div
                                                                style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; margin: 16px 0;">
                                                                <% if (filterProductId !=null &&
                                                                    !filterProductId.trim().isEmpty()) { %>
                                                                    <a href="${pageContext.request.contextPath}/admin/variants"
                                                                        class="btn-export"
                                                                        style="background-color: #64748b; border: 1px solid #64748b; display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; color: #ffffff; padding: 8px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; height: 38px;">
                                                                    ...
                                                                    <% } %>
                                                                        ...
                                                                        <a href="${pageContext.request.contextPath}/admin/variants?action=exportExcel"
                                                                            class="btn-export"
                                                                            style="background-color: #10B981; border: 1px solid #10B981; display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; color: #ffffff; padding: 8px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; height: 38px;">
                                                            ...
                                                            <div class="custom-card">
                                                                <div class="card-header-bar">
                                                                    <span class="card-header-title">&#8226; Bảng dữ liệu
                                                                        biến thể</span>
                                                                </div>
                                                                <div style="overflow-x: auto;">
                                                                    <table class="invoice-table"
                                                                        ...
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th style="text-align: center;">Màu sắc
                                                                                </th>
                                                                                <th style="text-align: center;">Kích cỡ
                                                                                </th>
                                                                                <th style="text-align: center;">Giá nhập
                                                                                </th>
                                                                                <th style="text-align: center;">Giá bán
                                                                                </th>
                                                                                <th style="text-align: center;">Số lượng
                                                                                </th>
                                                                                <th style="text-align: center;">Trạng
                                                                                    thái</th>
                                                                        ...
                                                                        <tbody id="variantTbody">
                                                                            <% if (variants !=null &&
                                                                                !variants.isEmpty()) { int stt=1; for
                                                                                (ProductDetail v : variants) { boolean
                                                                                isAvailable=(v.getStock()> 0) &&
                                                                                (v.getStatus() != null && v.getStatus()
                                                                                == 1);
                                                                                String statusClass = isAvailable ?
                                                                                "available" : "out_of_stock";
                                                                                String statusLabel = isAvailable ? "Còn hàng" : "Hết hàng";
                                                                                %>
                                                                                <tr class="variant-data-row"
                                                                                    id="variant-row-<%= v.getId() %>"
                                                                                    data-variantid="<%= v.getId() %>"
                                                                                    data-code="<%= v.getCode() != null ? v.getCode() : "" %>"
                                                                                    data-productcode="<%= (v.getProduct() != null && v.getProduct().getCode() != null) ? v.getProduct().getCode().replace("\"", "&quot;" ) : "" %>"
                                                                                    data-color="<%= v.getColor() !=null
                                                                                        ?
                                                                                        v.getColor().replace("\"", "&quot;"
                                                                                        ) : "" %>" data-size="<%=
                                                                                            v.getSize() !=null ?
                                                                                                    ...
                                                                                                    data-status="<%=
                                                                                                        ...
                                                                                                        <td
                                                                                                            ...
                                                                                                            <% String
                                                                                                                ...
                                                                                                                !imgUrl.trim().isEmpty()
                                                                                                                &&
                                                                                                                !"null".equalsIgnoreCase(imgUrl.trim());
                                                                                                                String
                                                                                                                fullImgSrc=""
                                                                                                                ; if
                                                                                                                (hasValidImg)
                                                                                                                {
                                                                                                                fullImgSrc=(imgUrl.startsWith("http://")
                                                                                                                ||
                                                                                                                ...
                                                                                                                <img src="<%= fullImgSrc %>"
                                                                                                                    alt="Image"
                                                                                                                    style="width: 85px; height: 85px; object-fit: cover; border-radius: 10px; border: 1.5px solid #cbd5e1; display: inline-block; box-shadow: 0 2px 6px rgba(0,0,0,0.08); transition: transform 0.2s;"
                                                                                                                    onerror="this.style.display='none'; if(this.nextElementSibling) this.nextElementSibling.style.display='inline-flex';">
                                                                                                                <div
                                                                                                                    style="display: none; width: 85px; height: 85px; border-radius: 10px; background-color: #f8fafc; border: 1.5px dashed #cbd5e1; align-items: center; justify-content: center; color: #94a3b8; margin: 0 auto;">
                                                                                                                ...
                                                                                                                <% } else
                                                                                                                    { %>
                                                                                                                    <div
                                                                                                                        style="width: 85px; height: 85px; border-radius: 10px; background-color: #f8fafc; border: 1.5px dashed #cbd5e1; display: inline-flex; align-items: center; justify-content: center; color: #94a3b8; margin: 0 auto;">
                                                                                                                        <svg viewBox="0 0 24 24"
                                                                                                                            width="26"
                                                                                                                            height="26"
                                                                                                                            stroke="currentColor"
                                                                                                        ...
                                                                                                        <td
                                                                                                            style="text-align: center;">
                                                                                                            <span
                                                                                                                style="background-color: #f1f5f9; color: #475569; font-size: 12px; padding: 4px 8px; border-radius: 4px; font-weight: 600;">
                                                                                                                <%= v.getSize()
                                                                                                                    !=null
                                                                                                                    ?
                                                                                                                    v.getSize()
                                                                                                            ...
                                                                                                            <%-- IF MANAGER REMOVED --%>
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <a href="javascript:void(0)"
                                                                                                                        onclick="openViewVariantModal(this)"
                                                                                                                        ...
                                                                                                                        data-importprice="<%= String.format("%.0f",
                                                                                                                        v.getImportPrice())
                                                                                                                        %>"
                                                                                                                        data-price="
                                                                                                                        <%= String.format("%.0f",
                                                                    ...
                                                                    <div class="pagination-wrapper"
                                                                        ...
                                                                        <div id="paginationContainer"
                                                                            ...
                                                                            style="padding: 0; margin-top: 0;"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                </div>
                            ...
                            <div
                                ...
                                <div style="padding: 24px; overflow-y: auto;">
                                    <form id="editVariantForm"
                                        action="${pageContext.request.contextPath}/admin/variants" method="POST"
                                        ...
                                        <div
                                            ...
                                            <button type="button" onclick="closeEditVariantModal()"
                                                style="padding: 8px 16px; border: 1px solid #cbd5e1; background: #ffffff; color: #475569; border-radius: 8px; font-weight: 600; font-size: 13px; cursor: pointer; transition: all 0.2s;">Hủy
                                                bỏ</button>
                                            <button type="button" onclick="confirmSaveVariant()"
                                                style="padding: 8px 16px; background-color: #1e3a8a; color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 13px; cursor: pointer; transition: background 0.2s;">Lưu
                                                thay đổi</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <script>
                            ...
                            function openViewVariantModal(btn) {
                                document.getElementById('view-productCode').value = btn.getAttribute('data-productcode') || '';
                                document.getElementById('view-variantCode').value = btn.getAttribute('data-variantcode') || '';
                                document.getElementById('view-color').value = btn.getAttribute('data-color') || '';
                                document.getElementById('view-size').value = btn.getAttribute('data-size') || '';
                                ...
                                var placeholderEl = document.getElementById('view-variantImagePlaceholder');
                                if (imgUrl && imgUrl.trim() !== '' && imgUrl !== 'null') {
                                    imgEl.src = imgUrl;
                                    imgEl.style.display = 'inline-block';
                                    placeholderEl.style.display = 'none';
                            ...
                            function closeViewVariantModal() {
                                document.getElementById('viewVariantModal').style.display = 'none';
                            }
                            ...
                            function applyFilters(page = 1) {
                                ...
                                const hasFilter = keyword || sizeFilter || statusFilter || (minPriceVal > SLIDER_MIN + 500) || (maxPriceVal < SLIDER_MAX - 500);
                            ...
                            function renderPagination(totalItems, totalPages) {
                                ...
                                if (infoContainer) {
                                    if (totalItems === 0) {
                                        ...
                                        infoContainer.innerHTML = 'Hiển thị <strong>' + (startIndex + 1) + '- ' + endIndex + '</strong> trong tổng <strong>' + totalItems + '</strong> biến thể';
                                    }
                                }
                    ...
                    <script src="${pageContext.request.contextPath}/assets/js/products/variant-list.js"></script>
