...
VALUES
('SP001', N'Áo khoác da nam cao cấp',         1, 2, 1, N'Chất liệu da thật cao cấp, lót lông ấm',            N'Nam',    N'Chỉ giặt khô',    1850000.00, 120, 1),
('SP002', N'Áo khoác denim nữ thời trang',    3, 3, 1, N'Denim nhập khẩu, form rộng thoải mái',              N'Nữ',     N'Giặt riêng màu',   750000.00,  95,  1),
('SP003', N'Áo khoác bomber unisex',           2, 4, 1, N'Kiểu dáng bomber năng động, chống gió',             N'Unisex', N'Giặt máy nhẹ',    1200000.00,  78,  1),
('SP004', N'Áo khoác len nữ công sở',          5, 2, 1, N'Len cao cấp, thiết kế thanh lịch',                  N'Nữ',     N'Giặt khô',        2100000.00,  45,  1),
('SP005', N'Áo khoác gió nam thể thao',        6, 5, 1, N'Chống gió, chống mưa nhẹ, trọng lượng nhẹ',        N'Nam',    N'Giặt máy thường',  650000.00, 210,  1),
('SP006', N'Áo khoác lông vũ nữ giữ nhiệt',   4, 4, 2, N'Lông vũ thiên nhiên, giữ ấm tối ưu',               N'Nữ',     N'Giặt máy nhẹ',    1650000.00,  88,  1),
('SP007', N'Áo khoác trench coat nữ',          7, 2, 1, N'Trench coat cổ điển, thích hợp công sở',            N'Nữ',     N'Giặt khô',        1900000.00,  55,  1),
...
('SP009', N'Áo khoác parka nam đông',          1, 5, 7, N'Parka cao cấp, chịu lạnh cực tốt',                  N'Nam',    N'Giặt khô',        2800000.00,  32,  0),
('SP010', N'Áo khoác varsity unisex phối màu', 2, 1, 1, N'Varsity jacket phong cách retro',                   N'Unisex', N'Giặt máy nhẹ',     980000.00, 140,  1),
('SP011', N'Áo khoác blazer nữ thanh lịch',   5, 2, 1, N'Blazer form slim, phù hợp công sở và dạo phố',     N'Nữ',     N'Giặt khô',        1450000.00,  68,  1),
('SP012', N'Áo khoác jean nam wash cũ',        3, 3, 1, N'Denim wash cũ phong cách vintage',                  N'Nam',    N'Giặt riêng màu',   820000.00, 180,  1),
('SP013', N'Áo khoác lông cừu nữ mùa đông',   4, 4, 1, N'Lông cừu giả mềm mịn, cực ấm mùa đông',           N'Nữ',     N'Giặt máy nhẹ',    1350000.00,  95,  1),
('SP014', N'Áo khoác military nam',            6, 3, 1, N'Phong cách military cá tính, nhiều túi tiện dụng', N'Nam',    N'Giặt máy thường', 1100000.00,  75,  1),
('SP015', N'Áo khoác cape nữ sang trọng',      7, 2, 7, N'Cape coat da cao cấp, dáng độc đáo',               N'Nữ',     N'Chỉ giặt khô',    2500000.00,  18,  0);
GO
...
VALUES
('HD0001',  1, 1,  1, 1, NULL, 0, '2026-06-01 08:30:00', NULL, N'Nguyễn Văn An',   '0901234567', N'25 Hàng Gai, Hà Nội',           2, 3700000.00,      0.00, 3700000.00, 3700000.00, 1, 3, 1),
('HD0002',  2, 2,  2, 2,    1, 0, '2026-06-03 10:15:00', NULL, N'Trần Thị Bích',   '0912345678', N'88 Lê Lợi, Hồ Chí Minh',       3, 5400000.00, 810000.00, 4590000.00, 4590000.00, 1, 3, 1),
('HD0003',  3, 3,  3, 2, NULL, 0, '2026-06-05 14:00:00', NULL, N'Lê Văn Cường',    '0923456789', N'12 Trần Phú, Đà Nẵng',          1, 1200000.00,      0.00, 1200000.00, 1200000.00, 1, 3, 1),
('HD0004',  4, 1,  4, 1,    5, 0, '2026-06-08 09:00:00', NULL, N'Phạm Thị Dung',   '0934567890', N'45 Đinh Tiên Hoàng, Hải Phòng', 2, 3100000.00,  30000.00, 2800000.00, 2800000.00, 1, 3, 1),
('HD0005',  5, 2,  5, 2,    2, 0, '2026-06-10 11:30:00', NULL, N'Hoàng Văn Em',    '0945678901', N'78 Nguyễn Trãi, Cần Thơ',       1,  650000.00,      0.00,  617500.00,       0.00, 0, 4, 1),
('HD0006',  6, 3,  6, 1, NULL, 0, '2026-06-12 16:00:00', NULL, N'Ngô Thị Phương',  '0956789012', N'99 Đại lộ Bình Dương',           4, 6600000.00,      0.00, 6600000.00, 6600000.00, 1, 3, 1),
('HD0007',  7, 1,  7, 1,    4, 0, '2026-06-15 08:45:00', NULL, N'Đặng Văn Giang',  '0967890123', N'3 Phạm Văn Thuận, Đồng Nai',    3, 4650000.00, 465000.00, 4185000.00, 4185000.00, 1, 3, 1),
('HD0008',  8, 2,  8, 2, NULL, 0, '2026-06-18 13:00:00', NULL, N'Bùi Thị Hà',      '0978901234', N'22 Lê Lợi, Huế',                2, 2900000.00,      0.00, 2900000.00, 2900000.00, 1, 3, 1);
GO
...
VALUES
('CTHD0001', 1,  1, 1850000.00,      0.00, 2, 3700000.00),
('CTHD0002', 2,  4,  750000.00,  67500.00, 1,  682500.00),
('CTHD0003', 2,  6, 1200000.00, 108000.00, 2, 2184000.00),
('CTHD0004', 3,  6, 1200000.00,      0.00, 1, 1200000.00),
('CTHD0005', 4, 12, 1650000.00,      0.00, 2, 3300000.00),
('CTHD0006', 5, 10,  650000.00,  32500.00, 1,  617500.00),
('CTHD0007', 6,  1, 1850000.00,      0.00, 2, 3700000.00),
('CTHD0008', 6,  3, 1950000.00,      0.00, 1, 1950000.00),
('CTHD0009', 7,  9, 2100000.00, 210000.00, 2, 3780000.00),
('CTHD0010', 8,  5,  750000.00,      0.00, 2, 1500000.00);
GO
...
VALUES
('LSHD0001', 1, 1, 0, 1, N'Tạo đơn hàng', '2026-06-01 08:30:00'),
('LSHD0002', 2, 2, 0, 1, N'Tạo đơn hàng', '2026-06-03 10:15:00'),
('LSHD0003', 3, 3, 0, 1, N'Tạo đơn hàng', '2026-06-05 14:00:00'),
('LSHD0004', 4, 1, 0, 1, N'Tạo đơn hàng', '2026-06-08 09:00:00'),
('LSHD0005', 5, 2, 0, 1, N'Tạo đơn hàng', '2026-06-10 11:30:00'),
('LSHD0006', 6, 3, 0, 1, N'Tạo đơn hàng', '2026-06-12 16:00:00'),
('LSHD0007', 7, 1, 0, 1, N'Tạo đơn hàng', '2026-06-15 08:45:00'),
('LSHD0008', 8, 2, 0, 1, N'Tạo đơn hàng', '2026-06-18 13:00:00');
GO
...
VALUES
('LSTT0001', 1, 'TXN20260601001', 3700000.00, N'Thanh toán tiền mặt - HD0001',      1, '2026-06-01 09:05:00'),
('LSTT0002', 2, 'VNP20260603001', 4590000.00, N'Thanh toán VNPay - HD0002',         1, '2026-06-03 10:50:00'),
('LSTT0003', 3, 'MOM20260605001', 1200000.00, N'Thanh toán MoMo - HD0003',          1, '2026-06-05 14:35:00'),
('LSTT0004', 4, 'TXN20260608001', 2800000.00, N'Thanh toán tiền mặt - HD0004',      1, '2026-06-08 09:35:00'),
('LSTT0005', 6, 'CK20260612001',  6600000.00, N'Chuyển khoản MB Bank - HD0006',     1, '2026-06-13 07:55:00'),
('LSTT0006', 7, 'TXN20260615001', 4185000.00, N'Thanh toán tiền mặt - HD0007',      1, '2026-06-15 09:20:00'),
('LSTT0007', 8, 'MOM20260618001', 2900000.00, N'Thanh toán MoMo - HD0008',          1, '2026-06-18 13:50:00'),
('LSTT0008', 5, 'VNP20260610001',  617500.00, N'VNPay - HD0005 - Thất bại',         0, '2026-06-10 11:35:00'),
('LSTT0009', 2, 'VNP20260603002',       0.00, N'Kiểm tra kết nối VNPay - HD0002',   0, '2026-06-03 10:47:00');
GO
...
-- =====================================================================
-- FIX MÃ HÓA ĐƠN THÀNH ĐỊNH DẠNG HD0000
-- =====================================================================
UPDATE hoa_don
SET hoa_don_code = 'HD' + RIGHT('0000' + CAST(REPLACE(hoa_don_code, 'HD', '') AS VARCHAR(10)), 4)
WHERE hoa_don_code LIKE 'HD%';
GO

-- =====================================================================
-- FIX MÃ CHI TIẾT HÓA ĐƠN THÀNH ĐỊNH DẠNG CTHD0000
-- =====================================================================
