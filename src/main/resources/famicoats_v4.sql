...
-- [5] trang_thai: giữ NVARCHAR vì giá trị là 'AVAILABLE'/'OUT_OF_STOCK'
--     (đây là status code nên NVARCHAR phù hợp hơn INT)
-- [6] thêm created_at, updated_at
-- ---------------------------------------------------------------------
CREATE TABLE san_pham (
    ...
    trang_thai         NVARCHAR(50)       NOT NULL DEFAULT 'AVAILABLE', -- 'AVAILABLE' | 'OUT_OF_STOCK'
    created_at         DATETIME           NOT NULL DEFAULT GETDATE(),   -- [6]
    updated_at         DATETIME           NOT NULL DEFAULT GETDATE()    -- [6]
);
GO
...
VALUES
('SP001', N'Áo khoác da nam cao cấp',         1, 1, 1, N'Chất liệu da thật cao cấp, lót lông ấm',            N'Nam',    N'Chỉ giặt khô',    1850000.00, 120, 'AVAILABLE'),
('SP002', N'Áo khoác denim nữ thời trang',    3, 1, 1, N'Denim nhập khẩu, form rộng thoải mái',              N'Nữ',     N'Giặt riêng màu',   750000.00,  95,  'AVAILABLE'),
('SP003', N'Áo khoác bomber unisex',           2, 1, 1, N'Kiểu dáng bomber năng động, chống gió',             N'Unisex', N'Giặt máy nhẹ',    1200000.00,  78,  'AVAILABLE'),
('SP004', N'Áo khoác len nữ công sở',          5, 1, 1, N'Len cao cấp, thiết kế thanh lịch',                  N'Nữ',     N'Giặt khô',        2100000.00,  45,  'AVAILABLE'),
('SP005', N'Áo khoác gió nam thể thao',        6, 1, 1, N'Chống gió, chống mưa nhẹ, trọng lượng nhẹ',        N'Nam',    N'Giặt máy thường',  650000.00, 210,  'AVAILABLE'),
('SP006', N'Áo khoác lông vũ nữ giữ nhiệt',   4, 1, 2, N'Lông vũ thiên nhiên, giữ ấm tối ưu',               N'Nữ',     N'Giặt máy nhẹ',    1650000.00,  88,  'AVAILABLE'),
('SP007', N'Áo khoác trench coat nữ',          7, 1, 1, N'Trench coat cổ điển, thích hợp công sở',            N'Nữ',     N'Giặt khô',        1900000.00,  55,  'AVAILABLE'),
('SP008', N'Áo khoác hoodie nam thường ngày',  8, 1, 1, N'Nỉ bông dày dặn, nón liền kiểu dáng trẻ trung',    N'Nam',    N'Giặt máy thường',  550000.00, 320,  'AVAILABLE'),
('SP009', N'Áo khoác parka nam đông',          1, 1, 7, N'Parka cao cấp, chịu lạnh cực tốt',                  N'Nam',    N'Giặt khô',        2800000.00,  32,  'OUT_OF_STOCK'),
('SP010', N'Áo khoác varsity unisex phối màu', 2, 1, 1, N'Varsity jacket phong cách retro',                   N'Unisex', N'Giặt máy nhẹ',     980000.00, 140,  'AVAILABLE'),
('SP011', N'Áo khoác blazer nữ thanh lịch',   5, 1, 1, N'Blazer form slim, phù hợp công sở và dạo phố',     N'Nữ',     N'Giặt khô',        1450000.00,  68,  'AVAILABLE'),
('SP012', N'Áo khoác jean nam wash cũ',        3, 1, 1, N'Denim wash cũ phong cách vintage',                  N'Nam',    N'Giặt riêng màu',   820000.00, 180,  'AVAILABLE'),
('SP013', N'Áo khoác lông cừu nữ mùa đông',   4, 1, 1, N'Lông cừu giả mềm mịn, cực ấm mùa đông',           N'Nữ',     N'Giặt máy nhẹ',    1350000.00,  95,  'AVAILABLE'),
('SP014', N'Áo khoác military nam',            6, 1, 1, N'Phong cách military cá tính, nhiều túi tiện dụng', N'Nam',    N'Giặt máy thường', 1100000.00,  75,  'AVAILABLE'),
('SP015', N'Áo khoác cape nữ sang trọng',      7, 1, 7, N'Cape coat da cao cấp, dáng độc đáo',               N'Nữ',     N'Chỉ giặt khô',    2500000.00,  18,  'OUT_OF_STOCK');
GO
...
VALUES
('CTSP001',  1, 2,  1, 1,  1850000.00, 15, 0.900, 70, 55, 0.30, 'AVAILABLE'),
('CTSP002',  1, 3,  1, 1,  1850000.00, 12, 0.950, 72, 57, 0.30, 'AVAILABLE'),
('CTSP003',  1, 4,  2, 1,  1950000.00,  8, 1.000, 74, 59, 0.30, 'AVAILABLE'),
('CTSP004',  2, 1,  3, 2,   750000.00, 20, 0.500, 65, 50, 0.20, 'AVAILABLE'),
('CTSP005',  2, 2,  3, 2,   750000.00, 25, 0.520, 67, 52, 0.20, 'AVAILABLE'),
('CTSP006',  3, 2,  1, 3,  1200000.00, 10, 0.650, 68, 54, 0.25, 'AVAILABLE'),
('CTSP007',  3, 3,  6, 3,  1200000.00, 10, 0.680, 70, 56, 0.25, 'AVAILABLE'),
('CTSP008',  4, 1,  4, 4,  2100000.00,  8, 0.850, 66, 52, 0.35, 'AVAILABLE'),
('CTSP009',  4, 2,  5, 4,  2100000.00,  6, 0.880, 68, 54, 0.35, 'AVAILABLE'),
('CTSP010',  5, 2,  1, 1,   650000.00, 30, 0.350, 68, 52, 0.15, 'AVAILABLE'),
('CTSP011',  5, 3, 10, 1,   650000.00, 35, 0.370, 70, 54, 0.15, 'AVAILABLE'),
('CTSP012',  6, 2,  7, 1,  1650000.00, 12, 0.800, 68, 54, 0.40, 'AVAILABLE'),
('CTSP013',  6, 3,  8, 1,  1650000.00, 15, 0.820, 70, 56, 0.40, 'AVAILABLE'),
('CTSP014',  7, 1,  9, 5,  1900000.00,  0, 0.900, 64, 50, 0.35, 'OUT_OF_STOCK'),
('CTSP015',  8, 4, 11, 6,   550000.00, 50, 0.550, 72, 58, 0.30, 'AVAILABLE');
GO
